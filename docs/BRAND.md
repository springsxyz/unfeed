...
## Extension icon
Lime rounded square (`#c8e046`) with a stacked **feed** (avatar + lines ×3) and a **diagonal slash** through it. Generated by `scripts/generate-icons.ps1` → `icons/icon{16,48,128}.png`.
