...
## Extension icon
Polished gradient squircle (slate → teal → lime) with a white-ringed dark lens and a lime **face** inside (Awesome Screenshot–style finish, UnFeed metaphor). Generated by `scripts/generate-icons.ps1`.
